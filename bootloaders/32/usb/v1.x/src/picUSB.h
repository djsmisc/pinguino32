...
typedef union __attribute__ ((packed))
{
    struct __attribute__ ((packed))
    {
        ...
        //unsigned char addrh;
        //unsigned char addru;
        unsigned char xdat[ EP1_BUFFER_SIZE - 6 ];
    };
...
extern word wCount; // Total # of bytes to move
...
extern volatile BufferDescriptorTable ep_bdt[32];
...
#define ConvertToPhysicalAddress(a) ((unsigned long)(a) & 0x1fffffff)
#define ConvertToVirtualAddress(a)  ((void *) ((a) | 0xa0000000))

// USB Functions
void BOOTZONE EnableUSBModule(void);
void BOOTZONE ProcessUSBTransactions(void);
