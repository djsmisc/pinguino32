...
/*
#if defined(__18f14k50)
extern volatile setupPacketStruct __at 0x210 SetupPacket;
extern volatile allcmd __at (0x290) bootCmd;
#else
extern volatile setupPacketStruct __at 0x0410 SetupPacket;
extern volatile allcmd __at (0x490) bootCmd;
#endif
*/
...
//extern __code unsigned char string_descriptor[3][22];
