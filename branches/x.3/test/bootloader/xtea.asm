...
;--------------------------------------------------------------------
;  $Id: xtea.asm,v 1.1.1.1 2006/02/16 17:37:44 mtvs12 Exp $
;--------------------------------------------------------------------
INCLUDE "p18cxxx.inc"
...
XTEA_ITERATIONS	        equ     0x40            ; Number of iterations on x1,x2
        ...
        CODE_PACK       0x001C          ; Place ROM constants after vectors
;-----------
; Inject KEY
; XTEA_KEY db "0123456789ABCDEF" - 16byte Key
INCLUDE "xtea_key.inc"
;-----------
