...
class Documents():
    ...
    def __initDocuments__(self):
        ...
        self.lateralVars.InsertColumn(col=0, format=wx.LIST_FORMAT_LEFT, heading='Variable', width=-1)
        self.lateralVars.InsertColumn(col=1, format=wx.LIST_FORMAT_LEFT, heading='Type', width=-1)
        self.lateralVars.InsertColumn(col=2, format=wx.LIST_FORMAT_LEFT, heading='Line', width=-1)
        self.lateralVars.InsertColumn(col=3, format=wx.LIST_FORMAT_LEFT, heading='In function', width=-1)
