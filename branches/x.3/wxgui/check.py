...
try:	
    ...
    fichier.writelines('You should have editeur.py at the wxgui/\n')
    fichier.close()
    perror()
...
try:
    ...
    fichier.writelines('Pinguino Frame successfully loaded\n')
except:
    fichier.writelines('Pinguino Frame failed\n')
...
try:
    from tools import Tools
    fichier.writelines('Tools successfully loaded\n')
except:
    fichier.writelines('Tools failed\n')
    fichier.writelines('You should have tools.py at the wxgui/tools/\n')
    fichier.close()
    perror()	
