...
void IR_reception()
{
	...
	{
		case LEFT:
			serial1printf("Obstacle on the left\n");
			break;
		case RIGHT:
			serial1printf("Obstacle on the right\n");
			break;
		default:
			serial1printf("Get Signal from another IR source\n");
			break;
	}
}
...
void setup()
{
	...
	#endif
	serial1printf("************************\n");
	serial1printf("* IR Obstacle Detector *\n");
	serial1printf("************************\n");
