...
Remarks:        This routine starts resume signaling.  It will be turned off 
...
BOOL USBHALEndpointHasBeenStalled ( TRANSFER_FLAGS endpoint );
...
/****************************************************************************
  Function:
    void USBHALDisable ( void )

  Description:
    This interface disables the USB module (disconnecting from the bus if 
    connected).
...
#define USBHALDisable()  (U1PWRCbits.USBPWR = 0)
