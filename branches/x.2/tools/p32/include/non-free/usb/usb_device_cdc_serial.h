...
#define EVENT_CDC_SUSPEND   (EVENT_USER_BASE+EVENT_CDC_OFFSET+4)
        // Notifies the application that the CDC UART has been suspended
        // To do 

#define EVENT_CDC_ATTACH    (EVENT_USER_BASE+EVENT_CDC_OFFSET+5)
        // Notifies the application that the CDC UART has attached
        // data: NULL
        // size: 0

#define EVENT_CDC_DETACH    (EVENT_USER_BASE+EVENT_CDC_OFFSET+6)
        // Notifies the appliication that the CDC UART has detatched
        // data: NULL
        // size: 0
