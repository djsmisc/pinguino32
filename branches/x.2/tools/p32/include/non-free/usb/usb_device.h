/******************************************************************************
  ...
  USB Device Abstraction Layer Header File

This file defines the interface to the USB Device Abstraction Layer, used by
applications and device "function" drivers to access and communicate with a 
...
--------------------------------------------------------------------------------
BC             10-11-2006 Initial implementation
