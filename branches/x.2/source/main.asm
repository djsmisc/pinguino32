...
; This file was generated Tue Apr 12 19:38:58 2011
;--------------------------------------------------------
...
S_main__setup	code
_setup:
;	.line	108; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	const u8 eacute[8]={
	MOVLW	0x04
	BANKSEL	_setup_eacute_1_1
	MOVWF	_setup_eacute_1_1, B
	MOVLW	0x08
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 1), B
	MOVLW	0x0e
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 2), B
	MOVLW	0x11
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 3), B
	MOVLW	0x1f
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 4), B
	MOVLW	0x10
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 5), B
	MOVLW	0x0e
; removed redundant BANKSEL
	MOVWF	(_setup_eacute_1_1 + 6), B
; removed redundant BANKSEL
	CLRF	(_setup_eacute_1_1 + 7), B
;	.line	119; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_init(16, 2, 0b01001110);// display is 2x16, ic2 address is 01001110 (see above)
	MOVLW	0x4e
	MOVWF	POSTDEC1
	MOVLW	0x02
	MOVWF	POSTDEC1
	...
	MOVLW	0x03
	ADDWF	FSR1L, F
;	.line	120; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_backlight();				// turns backlight on
	CALL	_lcdi2c_backlight
;	.line	121; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_clear();					// clear screen
	CALL	_lcdi2c_clear
;	.line	122; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_home();						// set cursor at (0,0)
	CALL	_lcdi2c_home
;	.line	123; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_printf("   lcdi2c demo  ");
	MOVLW	UPPER(__str_3)
	MOVWF	POSTDEC1
	MOVLW	HIGH(__str_3)
	MOVWF	POSTDEC1
	...
	MOVLW	0x03
	ADDWF	FSR1L, F
;	.line	124; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_setCursor(0, 1);			// set cursor at line 1, col 0
	MOVLW	0x01
	MOVWF	POSTDEC1
	MOVLW	0x00
	CLRF	POSTDEC1
	...
	MOVLW	0x02
	ADDWF	FSR1L, F
;	.line	125; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_printf(" Regis Blanchot ");
	MOVLW	UPPER(__str_4)
	MOVWF	POSTDEC1
	MOVLW	HIGH(__str_4)
	MOVWF	POSTDEC1
	...
	MOVLW	0x03
	ADDWF	FSR1L, F
;	.line	127; /home/regis/Hobbies/Electronique/Projets/PinguinoIDE/X/branches/linux/source/user.c	lcdi2c_newchar(eacute, 0);		// eacute is assigned to ascii 0
	CLRF	POSTDEC1
	MOVLW	0x80
	MOVWF	POSTDEC1
	MOVLW	HIGH(_setup_eacute_1_1)
	MOVWF	POSTDEC1
	MOVLW	LOW(_setup_eacute_1_1)
	MOVWF	POSTDEC1
