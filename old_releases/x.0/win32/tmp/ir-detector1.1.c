...
#define IR_RECEIVER		0 	// TSOP1738 is  connected on pin RB0  #0
#define IR_LEFT_LED		1	// Left  IR Led connected on pin RB1  #1
#define IR_RIGHT_LED		2	// Right IR Led connected on pin RB2  #2
#define PWM1				12 // PWM Output             on pin CCP1 #12
...
void setup()
{
	...
	PWM.setpercentdutycycle(PWM1, 25);					// Set PWM duty cycle to 25%
