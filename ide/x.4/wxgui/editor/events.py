...
#----------------------------------------------------------------------                
    ...
    def OnAbout(self, event):
        ...
        info.AddDeveloper('R’Hgis Blanchot')
        ...
        info.AddDeveloper('Bj’Urn Pfeiffer')
        info.AddDeveloper('Alexis S’@nchez')     
        ...
        info.AddDocWriter('R’Hgis Blanchot')

        info.AddArtist('France Cadet')
        info.AddArtist('Laurent Costes')
        info.AddArtist('Daniel Rodr’L‘«guez')

        info.AddTranslator('Joan Espinoza')
        info.AddTranslator('Alexis S’@nchez')
        info.AddTranslator('R’Hgis Blanchot')
